...
const Home = () => {
  ...
  return (
    <>
        ...
        <div className="section-container mx-auto">
          <div className="grid gap-4 md:grid-cols-2 items-center">
            ...
            >
              ...
              <NavLink to="/products">
                <button className="mt-3 bg-gradient-to-r from-pink-500 to-purple-500 text-white px-6 py-2 rounded-full font-semibold flex items-center gap-2 shadow-md hover:scale-105 transition">Purchase Now</button>
              </NavLink>
            </div>
            <div className="flex justify-end">
              <img
                className="md:h-[550px] sm:h-[400px] transition-transform duration-300 hover:scale-105 img-responsive"
                src={heroImage}
                alt="hero-image"
              />
            </div>
      ...
      <ProductSlider />
      <section className="bg-light dark:bg-dark-primary">
        <div className="section-container">
        ...
        <div className="section-container mb-[-5px] mt-[-60px]">
